...
dependencies:
  flutter:
    sdk: flutter
  google_mobile_ads: ^3.1.0   # ho an'ny ads
  shared_preferences: ^2.1.1   # hitahiry coins
...
class CoinsGame extends StatefulWidget {
  @override
  _CoinsGameState createState() => _CoinsGameState();
}

class _CoinsGameState extends State<CoinsGame> {
  int coins = 0;
  ...
  void _loadRewardedAd() {
    RewardedAd.load(
      adUnitId: 'YOUR_REWARDED_AD_UNIT_ID', // ova amin'ny AdMob ID anao
      request: AdRequest(),
  ...
  void _showRewardedAd() {
    ...
    rewardedAd!.show(
      onUserEarnedReward: (AdWithoutView ad, RewardItem reward) {
        setState(() {
          coins += 10; // valisoa rehefa mijery video
        });
        _saveCoins();
      },
    );
    rewardedAd = null;
    _loadRewardedAd(); // ento indray raha te hampiseho indray
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Coins Game')),
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text('Watch Video → +10 Coins'),
            ),
            SizedBox(height: 20),
            ElevatedButton(
              onPressed: _buyCoins,
